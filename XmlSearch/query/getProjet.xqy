...
let $infos :=
	...
	then <informations>{$projet/shortname}{$projet/projectName}{$projet/theme}{$projet/domaine}{$projet/ancestor::raweb/presentation}{$projet/ancestor::raweb/logiciels}{$projet/ancestor::raweb/resultat}{$projet/ancestor::raweb/contrats}</informations>
